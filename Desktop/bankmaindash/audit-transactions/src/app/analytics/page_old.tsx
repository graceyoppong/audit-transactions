...
const Analytics: React.FC = () => {
  ...
  const currentTransactions = selectedService
    ? allTransactions.filter(t => {
        ...
        return service ? t.description?.toLowerCase().includes(service.name.toLowerCase()) : false;
      })
    : allTransactions;
  ...
  // Use the analytics data from the hook
  const serviceAnalytics = servicesAnalytics;
          ...
          <div className="p-6 lg:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-gray-900 dark:text-white">
                    GH₵ {currentTotalAmount.toFixed(2)}
                  </div>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-gray-900 dark:text-white">
                    {selectedService ? currentFailedTransactions : serviceAnalytics.length}
                  </div>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    {selectedService
